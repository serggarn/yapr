...
namespace json_tags {
    ...
    static const std::string lootGeneratorConfig = "lootGeneratorConfig";
    static const std::string period = "period";
    static const std::string probability = "probability";
    static const std::string lootTypes = "lootTypes";
    static const std::string lostObjects = "lostObjects";
    ...
    static const std::string defaultBagCapacity = "defaultBagCapacity";
    static const std::string bagCapacity = "bagCapacity";
