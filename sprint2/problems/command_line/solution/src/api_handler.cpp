        ...
        case http::verb::post: {
            try {
                ...
                if (userName.size() == 0) {
                    ...
                    std::shared_ptr<model::GameSession> game_session{nullptr};
                    ...
                    if (game_session == nullptr) {
                        ...
                        game_session = game_.FindGameSession(model::GameSession::Id{mapId.c_str()});
                    }
