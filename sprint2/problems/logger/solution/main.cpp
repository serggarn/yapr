...
int main() {
    ...
    const std::filesystem::path reference_path = std::filesystem::current_path() / std::filesystem::path("/home/serg/workspace/yapractica/cpp-backend/cpp-backend-tests-practicum/tests/cpp/test_s02_logger/reference/");
